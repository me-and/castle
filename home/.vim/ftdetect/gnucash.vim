...
autocmd BufReadPre,FileReadPre *.gnucash setlocal bin
autocmd BufReadPost,FileReadPost *.gnucash call gnucash#read("gzip -dn")
autocmd BufWritePost,FileWritePost *.gnucash call gnucash#write("gzip")
autocmd FileAppendPre *.gnucash call gnucash#appre("gzip -dn")
autocmd FileAppendPost *.gnucash call gnucash#write("gzip")
